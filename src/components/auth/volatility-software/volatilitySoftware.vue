                                ...
                                <form id="ContForm1" class="contact-form form-contact"
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 email-field">
                                        <div class="form-group">
                                            ...
                                            <template v-if="!firstNameError">
                                                <label v-show="errors.has('first name')" class="error">{{ errors.first('first name') }}</label>
                                            </template>
                                            <template v-if="firstNameError">
                                              <label class="error">*The first name field is required</label>
                                            </template>
                                            <template v-if="firstNameValidError">
                                              <label class="error">Please enter valid first name</label>
                                            </template>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 email-field">
                                        <div class="form-group">
                                            ...
                                            <template v-if="lastNameError">
                                              <label class="error">Please enter valid last name</label>
                                            </template>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 email-field">
                                        <div class="form-group">
                                            ...
                                            <template v-if="emailError">
                                              <label class="error">The email field is required</label>
                                            </template>
                                            <template v-if="emailValidError">
                                              <label class="error">The email field must be a valid email</label>
                                            </template>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 email-field">
                                        <div class="form-group">
                                            ...
                                            <template v-if="!userNameError">
                                                <label v-show="errors.has('user name')" class="error">{{ errors.first('user name') }}</label>
                                            </template>
                                            <template v-if="userNameError">
                                              <label class="error">The username field is required</label>
                                            </template>
                                            <template v-if="userNameLengthError">
                                              <label class="error">User Name should have minimum 8 characters.</label>
                                            </template>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 email-field">
                                        <div class="form-group">
                                            ...
                                            <template v-if="passwordValidError">
                                              <label class="error">Should contain at least one special character, numeric digit, uppercase and lowercase letter</label>
                                            </template>
                                            <template v-if="passwordError">
                                              <label class="error">The password field is required</label>
                                            </template>
                                            <template v-if="minPasswordLengthError">
                                              <label class="error">Password should have more than 6 characters.</label>
                                            </template>
                                            <template v-if="maxPasswordLengthError">
                                              <label class="error">Password should have less than 20 characters.</label>
                                            </template>
                                            <template v-if="passwordMismatchError">
                                              <label class="error">Password mismatch.</label>
                                            </template>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 email-field">
                                        <div class="form-group">
                                            ...
                                            <template v-if="!confirmPasswordError">
                                              <label v-show="errors.has('confirm password')" class="error">{{ errors.first('confirm password') }}</label>
                                            </template>
                                            <template v-if="confirmPasswordError">
                                              <label class="error">The password field is required.</label>
                                            </template>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 email-field">
                                        <div class="form-group" style="margin-top:20px">
                                            ...
                                            <template v-if="!sponsorError">
                                              <label>If you don't have sponsor, then leave it blank</label>
                                            </template>
                                            <template v-if="sponsorError">
                                            ...
                                            <label class="error"
                                                  v-if="(signup.sponsor == signup.userName) && signup.sponsor">User name and sponsor can not be same.</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-xs-12 dob-field">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <template v-if="!dobError">
                                            <label v-show="errors.has('date of birth')" class="error">{{ errors.first('date of birth') }}</label>
                                          </template>
                                          <template v-if="dobError">
                                            <label class="error">The Date of Birth field is required.</label>
                                          </template>
                                      </div>
            ...
            validateBeforeSubmit: function () {
              ...
              if (this.signup.contactNo.trim() == ''){
                  ...
                  if (!/^\d+$/.test(this.signup.contactNo.trim())) {
                    ...
                    if (this.signup.contactNo.trim().length < 7 || this.signup.contactNo.trim().length > 15) {
